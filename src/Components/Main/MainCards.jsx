...
const MainCards = ({key, item , play}) => {
  ...
  <div className='  '>
                 ...
                 <div onClick={() => handleClick(item, item.id)} key={key} className='card border group duration-200 px-4 w-full  max-sm:px-4  max-md:px-0 hover:bg-[#272727]  cursor-pointer max-md:w-48 max-xl:px-2   max-md:h-full max-sm:w-44 max-xl:w-full   max-xl:h-full max-lg:h-full shadow-white'>
